...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐰ι𝓩ａ𝔯Ⓓ-ʙᴏᴛ',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐰ι𝓩ａ𝔯Ⓓ-ʙᴏᴛ;255765913582;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐰ι𝓩ａ𝔯Ⓓ-ʙᴏᴛ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐰ι𝓩ａ𝔯Ⓓ-ʙᴏᴛ' : process.env.STICKER_DATA,
